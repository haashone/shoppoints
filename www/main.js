...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_shared_tabs_tabs_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./shared/tabs/tabs.module */ 8717)).then(m => m.TabsPageModule)
    },
    {
        path: 'gifts',
    ...
    {
        path: 'filter-modal',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_shared_modals_filter-modal_filter-modal_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./shared/modals/filter-modal/filter-modal.module */ 3602)).then(m => m.FilterModalPageModule)
    }
];
